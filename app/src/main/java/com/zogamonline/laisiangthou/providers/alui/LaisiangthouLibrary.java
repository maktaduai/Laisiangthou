...
import com.zogamonline.laisiangthou.items.lst.Chapter;
import com.zogamonline.laisiangthou.items.lst.Testament;
...
public class LaisiangthouLibrary {
    private static final String TAG = "LaisiangthouLibrary";
        ...
        try {
            try {
                ...
                while (cursor.moveToNext()) {
                    testaments.add(new Testament(cursor.getInt(cursor
                            .getColumnIndex(Testament.ID)), cursor
                            .getString(cursor.getColumnIndex(Testament.NAME))));
                }
            } finally {
                if (cursor != null) {
                    cursor.close();
    ...
    public static Cursor getTestamentsCursor(final ContentResolver resolver) {
        return resolver.query(Testament.CONTENT_URI, new String[]{
                        Testament.ID, Testament.NAME}, null, null,
                Testament.DEFAULT_SORT_ORDER);
    }
    ...
    public static List<Book> getBooks(final ContentResolver resolver) {
        ...
        try {
            try {
                ...
                while (cursor.moveToNext()) {
                    books.add(new Book(cursor.getInt(cursor
                            .getColumnIndex(Book.ID)), cursor.getString(cursor
                            .getColumnIndex(Book.NAME))));
                }
            } finally {
                if (cursor != null) {
                    cursor.close();
    ...
    public static Cursor getBooksCursor(final ContentResolver resolver) {
        return resolver.query(Book.CONTENT_URI, new String[]{Book.ID,
                Book.NAME}, null, null, Book.DEFAULT_SORT_ORDER);
    }
    ...
    public static Cursor getBooksCursor(final ContentResolver resolver,
                                        final int testamentId) {
        return resolver.query(Book.CONTENT_URI, new String[]{Book.ID,
                        Book.NAME}, "TestamentID = " + testamentId, null,
    ...
    public static Book getBook(final ContentResolver resolver, final int bookId) {
        ...
        try {
            try {
                ...
                while (cursor.moveToNext()) {
                    book = new Book(cursor.getInt(cursor
                            .getColumnIndex(Book.ID)), cursor.getString(cursor
                            .getColumnIndex(Book.NAME)));
                }
            } finally {
    ...
    public static int getChapterCount(final ContentResolver resolver,
        ...
        try {
            try {
                cursor = resolver.query(Chapter.getCountUri(bookId),
    ...
    public static List<Chapter> getChapters(final ContentResolver resolver,
                                            final Book book) {
    ...
    public static List<Chapter> getChapters(final ContentResolver resolver,
        ...
        try {
            try {
                ...
                while (cursor.moveToNext()) {
                    chapters.add(new Chapter(cursor.getInt(cursor
                            .getColumnIndex(Chapter.ID)), cursor.getInt(cursor
                            .getColumnIndex(Chapter.BOOK_ID))));
                }
            } finally {
                if (cursor != null) {
                    cursor.close();
    ...
    public static Cursor getChaptersCursor(final ContentResolver resolver,
                                           final int bookId) {
        return resolver.query(Chapter.getContentUri(bookId), new String[]{
                        Chapter.ID, Chapter.BOOK_ID}, Chapter.getWhereClause(bookId),
                null, Chapter.DEFAULT_SORT_ORDER);
    }

    // Get one chapter in a book
    public static Chapter getChapter(final ContentResolver resolver,
                                     final Book book, final int chapter) {
    ...
    public static int getVerseCount(final ContentResolver resolver,
        ...
        try {
            try {
                cursor = resolver.query(Verse.getCountUri(bookId, chapter),
    ...
    public static List<Verse> getVerses(final ContentResolver resolver,
                                        final Book book, final int chapter) {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    verses.add(new Verse(
                            cursor.getInt(cursor.getColumnIndex(Verse.ID)),
    ...
    public static Cursor getVersesCursor(final ContentResolver resolver,
                                         final int bookId, final int chapter) {
        return resolver.query(Verse.getContentUri(bookId, chapter),
                new String[]{Verse.ID, Verse.NUMBER, Verse.TEXT,
                        Verse.BOOK_ID, Verse.CHAPTER},
                Verse.getWhereClause(bookId, chapter), null,
                Verse.DEFAULT_SORT_ORDER);
    }

    // Get one verse for a chapter
    public static Verse getVerse(final ContentResolver resolver,
                                 final Book book, final int chapter, final int verse) {
        ...
        try {
            try {
                cursor = resolver.query(
                        Verse.getContentUri(bookId, chapter, verse),
                        new String[]{Verse.ID, Verse.NUMBER, Verse.TEXT,
                                Verse.BOOK_ID, Verse.CHAPTER},
        ...
        try {
            try {
                cursor = resolver.query(Verse.getContentUri(verseId),
                        new String[]{Verse.ID, Verse.NUMBER, Verse.TEXT,
                                Verse.BOOK_ID, Verse.CHAPTER},
                        Verse.getWhereClause(verseId), null,
                        Verse.DEFAULT_SORT_ORDER);
    ...
    public static Cursor getVersesCursor(final ContentResolver resolver,
                                         final String where) {
        return resolver.query(Verse.getContentUri(), new String[]{Verse.ID,
                        Verse.NUMBER, Verse.TEXT, Verse.BOOK_ID, Verse.CHAPTER},
