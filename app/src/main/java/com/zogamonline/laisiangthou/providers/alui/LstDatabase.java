 ...
 */
public class LstDatabase extends SQLiteOpenHelper {

    private static String DATABASE_NAME = "bible-2.db";
    private final Context context;
    private SQLiteDatabase database;

    public LstDatabase(Context context) {
    ...
    private void copyDatabase() throws IOException {
        ...
        int[] resources = new int[]{R.raw.laa, R.raw.lab, R.raw.lac, R.raw.lad, R.raw.lae};
